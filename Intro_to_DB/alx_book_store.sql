...
CREATE TABLE `books` (
  ...
  `publican_date` date DEFAULT NULL,
  PRIMARY KEY (`book_id`),
...
CREATE TABLE `orders_details` (
  ...
  KEY `book_id` (`book_id`),
  CONSTRAINT `orders_details_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`),
  CONSTRAINT `orders_details_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`book_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-08-06 20:14:49
